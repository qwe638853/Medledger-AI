...
const (
	HealthService_AnalyzeHealthReportForUser_FullMethodName    = "/health.HealthService/AnalyzeHealthReportForUser"
	HealthService_AnalyzeHealthReportForInsurer_FullMethodName = "/health.HealthService/AnalyzeHealthReportForInsurer"
	HealthService_ParseDocument_FullMethodName                 = "/health.HealthService/ParseDocument"
	HealthService_GetHealthAnalysis_FullMethodName             = "/health.HealthService/GetHealthAnalysis"
...
type HealthServiceClient interface {
	...
	// ========================
	AnalyzeHealthReportForUser(ctx context.Context, in *AnalyzeHealthReportRequest, opts ...grpc.CallOption) (*UserHealthAnalysisResponse, error)
	AnalyzeHealthReportForInsurer(ctx context.Context, in *AnalyzeHealthReportRequest, opts ...grpc.CallOption) (*InsurerHealthAnalysisResponse, error)
	...
	// 前端請求健檢資料分析（通過報告 ID）
	GetHealthAnalysis(ctx context.Context, in *AnalyzeReportRequest, opts ...grpc.CallOption) (*HealthAnalysisResponse, error)
	// 健檢中心上傳報告
...
func (c *healthServiceClient) AnalyzeHealthReportForUser(ctx context.Context, in *AnalyzeHealthReportRequest, opts ...grpc.CallOption) (*UserHealthAnalysisResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserHealthAnalysisResponse)
	err := c.cc.Invoke(ctx, HealthService_AnalyzeHealthReportForUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *healthServiceClient) AnalyzeHealthReportForInsurer(ctx context.Context, in *AnalyzeHealthReportRequest, opts ...grpc.CallOption) (*InsurerHealthAnalysisResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InsurerHealthAnalysisResponse)
	err := c.cc.Invoke(ctx, HealthService_AnalyzeHealthReportForInsurer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *healthServiceClient) ParseDocument(ctx context.Context, in *ParseDocumentRequest, opts ...grpc.CallOption) (*ParseDocumentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ParseDocumentResponse)
	err := c.cc.Invoke(ctx, HealthService_ParseDocument_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *healthServiceClient) GetHealthAnalysis(ctx context.Context, in *AnalyzeReportRequest, opts ...grpc.CallOption) (*HealthAnalysisResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HealthAnalysisResponse)
	err := c.cc.Invoke(ctx, HealthService_GetHealthAnalysis_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HealthServiceServer interface {
	...
	// 健康分析功能（Python Backend 提供）
	// ========================
	AnalyzeHealthReportForUser(context.Context, *AnalyzeHealthReportRequest) (*UserHealthAnalysisResponse, error)
	AnalyzeHealthReportForInsurer(context.Context, *AnalyzeHealthReportRequest) (*InsurerHealthAnalysisResponse, error)
	// 解析文件（PDF/Word）並轉換為標準 JSON
	ParseDocument(context.Context, *ParseDocumentRequest) (*ParseDocumentResponse, error)
	// 前端請求健檢資料分析（通過報告 ID）
	GetHealthAnalysis(context.Context, *AnalyzeReportRequest) (*HealthAnalysisResponse, error)
	// 健檢中心上傳報告
...
func (UnimplementedHealthServiceServer) AnalyzeHealthReportForUser(context.Context, *AnalyzeHealthReportRequest) (*UserHealthAnalysisResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AnalyzeHealthReportForUser not implemented")
}
func (UnimplementedHealthServiceServer) AnalyzeHealthReportForInsurer(context.Context, *AnalyzeHealthReportRequest) (*InsurerHealthAnalysisResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AnalyzeHealthReportForInsurer not implemented")
}
func (UnimplementedHealthServiceServer) ParseDocument(context.Context, *ParseDocumentRequest) (*ParseDocumentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ParseDocument not implemented")
}
func (UnimplementedHealthServiceServer) GetHealthAnalysis(context.Context, *AnalyzeReportRequest) (*HealthAnalysisResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetHealthAnalysis not implemented")
}
...
func _HealthService_AnalyzeHealthReportForUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AnalyzeHealthReportRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HealthServiceServer).AnalyzeHealthReportForUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HealthService_AnalyzeHealthReportForUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServiceServer).AnalyzeHealthReportForUser(ctx, req.(*AnalyzeHealthReportRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _HealthService_AnalyzeHealthReportForInsurer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AnalyzeHealthReportRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HealthServiceServer).AnalyzeHealthReportForInsurer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HealthService_AnalyzeHealthReportForInsurer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServiceServer).AnalyzeHealthReportForInsurer(ctx, req.(*AnalyzeHealthReportRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _HealthService_ParseDocument_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ParseDocumentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HealthServiceServer).ParseDocument(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HealthService_ParseDocument_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServiceServer).ParseDocument(ctx, req.(*ParseDocumentRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _HealthService_GetHealthAnalysis_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AnalyzeReportRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HealthServiceServer).GetHealthAnalysis(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HealthService_GetHealthAnalysis_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServiceServer).GetHealthAnalysis(ctx, req.(*AnalyzeReportRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AnalyzeHealthReportForUser",
			Handler:    _HealthService_AnalyzeHealthReportForUser_Handler,
		},
		{
			MethodName: "AnalyzeHealthReportForInsurer",
			Handler:    _HealthService_AnalyzeHealthReportForInsurer_Handler,
		},
		{
			MethodName: "ParseDocument",
			Handler:    _HealthService_ParseDocument_Handler,
		},
		{
			MethodName: "GetHealthAnalysis",
			Handler:    _HealthService_GetHealthAnalysis_Handler,
		},
		{
