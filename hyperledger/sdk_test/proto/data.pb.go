...
const file_proto_data_proto_rawDesc = "" +
	"\n" +
	"\x10proto/data.proto\x12\x06health\x1a\x1cgoogle/api/annotations.proto\"\x81\x01\n" +
	...
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage2\xd8\x03\n" +
	"\rHealthService\x12`\n" +
	...
	"\bRegister\x12\x17.health.RegisterRequest\x1a\x18.health.RegisterResponse\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*\"\f/v1/registerB\x17Z\x15sdk_test/proto;healthb\x06proto3"
...
var file_proto_data_proto_depIdxs = []int32{
	...
	8, // 4: health.HealthService.Register:input_type -> health.RegisterRequest
	...
	9, // 9: health.HealthService.Register:output_type -> health.RegisterResponse
